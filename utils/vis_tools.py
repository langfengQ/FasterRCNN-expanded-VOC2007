...
COLOR = ['crimson', 'rosybrown', 'r', 'sandybrown', 'darkorange', 'gold', 'yellow', 'palegreen', 'g', 'aquamarine', 
        'c', 'deepskyblue', 'b', 'blueviolet', 'violet', 'lime', 'royalblue', 'pink', 'deeppink', 'thistle']
...
def vis_bbox(img, bbox, label=None, score=None, ax=None):
    ...
    for i, bb in enumerate(bbox):
        ...
        ax.add_patch(plt.Rectangle(
            xy, width, height, fill=False, edgecolor=color_, linewidth=2))
